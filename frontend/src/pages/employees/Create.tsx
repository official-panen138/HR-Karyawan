...
const employeeSchema = z.object({
  ...
  initial_salary: z.coerce.number().min(0, 'Gaji tidak boleh negatif'),
  current_salary: z.coerce.number().min(0, 'Gaji tidak boleh negatif'),
...
export default function EmployeeCreate() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Karyawan</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Field label="Gaji Awal" error={errors.initial_salary?.message}>
              <input type="number" {...register('initial_salary')} placeholder="0" className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm dark:text-white focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </Field>

            <Field label="Gaji Saat Ini" error={errors.current_salary?.message}>
              <input type="number" {...register('current_salary')} placeholder="0" className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm dark:text-white focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </Field>
